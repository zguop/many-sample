...
//        setMeasuredDimension(widthMeasureSpec, measuredHeight);
     ...
     * 设置保留view的个数 滑动的起始点
     */
    public void setKeepChild(int childNumber) {
        childLayout.getViewTreeObserver().addOnPreDrawListener(new ViewTreeObserver.OnPreDrawListener() {
            @Override
            public boolean onPreDraw() {
                childLayout.getViewTreeObserver().removeOnPreDrawListener(this);
    ...
    private ValueAnimator slideAnimator(int start, int end, boolean status) {
